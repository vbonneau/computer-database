...
import com.exilys.computerDatabase.service.CompanyService;
import com.exilys.computerDatabase.service.ComputerService;
...
public class Main {
	...
	private static boolean checkDate(LocalDateTime introduced, LocalDateTime discontinued) {
